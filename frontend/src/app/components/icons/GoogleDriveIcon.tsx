/** Official Google Drive triangle mark (brand colors). */
export function GoogleDriveIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M59.85 53H27.5l-13.75 23.8c1.35.8 2.9 1.2 4.5 1.2h41.2c1.6 0 3.15-.45 4.5-1.2z"
        fill="#2684fc"
      />
      <path
        d="m73.4 26.5-12.7-22c-.8-1.4-1.95-2.5-3.3-3.3L43.65 25 59.85 53h27.45c0-1.55-.4-3.1-1.2-4.5z"
        fill="#ffba00"
      />
    </svg>
  );
